...
# Never log account numbers, BVN, or passwords — CBN compliance requirement
LOGGING = {
    "version": 1,
    ...
    "loggers": {
        ...
        "nara": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}
...
TERMII_SENDER_ID = env("TERMII_SENDER_ID", default="NARA")
