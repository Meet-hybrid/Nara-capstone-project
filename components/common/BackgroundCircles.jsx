...
function FloatingCircle({ size, left, top, color = ACCENT, bgOpacity = 0.06, borderOnly = false, delay = 0, duration = 16000 }) {
...
const CIRCLES = [
  { size: 14, left: '10%', top: '5%', bgOpacity: 0.2, color: ACCENT },
  { size: 8, left: '80%', top: '3%', bgOpacity: 0.25, color: ACCENT },
  { size: 36, left: '70%', top: '14%', bgOpacity: 0.18, borderOnly: true, color: ACCENT },
  { size: 6, left: '92%', top: '12%', bgOpacity: 0.3, color: GOLD },
  { size: 200, left: -60, top: '0%', bgOpacity: 0.08, borderOnly: true, color: ACCENT, duration: 22000 },
  { size: 18, left: '5%', top: '24%', bgOpacity: 0.22, color: ACCENT },
  { size: 50, left: '82%', top: '30%', bgOpacity: 0.15, borderOnly: true, color: ACCENT, duration: 20000 },
  { size: 10, left: '90%', top: '24%', bgOpacity: 0.25, color: ACCENT },
  { size: 140, left: '-10%', top: '28%', bgOpacity: 0.07, borderOnly: true, color: ACCENT, duration: 25000 },
  { size: 28, left: '68%', top: '42%', bgOpacity: 0.18, color: ACCENT },
  { size: 8, left: '16%', top: '44%', bgOpacity: 0.28, color: ACCENT },
  { size: 220, left: '50%', top: '32%', bgOpacity: 0.06, borderOnly: true, color: ACCENT, duration: 26000 },
  { size: 16, left: '86%', top: '54%', bgOpacity: 0.2, color: ACCENT },
  { size: 40, left: '4%', top: '56%', bgOpacity: 0.16, borderOnly: true, color: ACCENT },
  { size: 12, left: '12%', top: '70%', bgOpacity: 0.22, color: ACCENT },
  { size: 180, left: '65%', top: '58%', bgOpacity: 0.07, borderOnly: true, color: ACCENT, duration: 24000 },
  { size: 22, left: '48%', top: '74%', bgOpacity: 0.2, color: ACCENT },
  { size: 8, left: '76%', top: '84%', bgOpacity: 0.28, color: GOLD },
  { size: 30, left: '86%', top: '74%', bgOpacity: 0.16, borderOnly: true, color: ACCENT },
  { size: 14, left: '33%', top: '88%', bgOpacity: 0.22, color: ACCENT },
  { size: 120, left: '-8%', top: '70%', bgOpacity: 0.07, borderOnly: true, color: ACCENT, duration: 20000 },
  { size: 70, left: '38%', top: '16%', bgOpacity: 0.1, borderOnly: true, color: ACCENT, duration: 18000 },
  { size: 8, left: '22%', top: '12%', bgOpacity: 0.3, color: GOLD },
  { size: 6, left: '46%', top: '30%', bgOpacity: 0.35, color: GOLD },
  { size: 18, left: '56%', top: '56%', bgOpacity: 0.18, color: ACCENT },
  { size: 44, left: '28%', top: '62%', bgOpacity: 0.14, borderOnly: true, color: ACCENT },
