...
export default function LoginScreen() {
  console.log('Rendering LoginScreen — member enters email and password');
  ...
  return (
    <View style={[styles.container, { backgroundColor: c.canvas }]}>
      ...
      <Text style={[styles.forgotLink, { color: c.forest }]} onPress={() => router.push('/(auth)/forgot-password')}>
        Forgot password?
      </Text>
