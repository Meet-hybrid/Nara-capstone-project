...
const styles = StyleSheet.create({
  container: { flex: 1 },
  content: { padding: spacing.xl, paddingTop: 80, gap: spacing.md },
  ...
  backLink: { fontSize: fontSize.base, fontFamily: 'Inter_400Regular', textAlign: 'center', textDecorationLine: 'underline' },
});
