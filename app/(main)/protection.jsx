...
export default function ProtectionScreen() {
  console.log('Rendering ProtectionScreen — insurance details');
      ...
      <Modal visible={modalVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={[styles.modal, { backgroundColor: c.surface }]}>
            ...
            <Text style={[styles.modalDesc, { color: c.slate }]}>Select the reason for your claim:</Text>
...
const styles = StyleSheet.create({
  ...
  modal: { borderRadius: radius.lg, padding: spacing.xl, gap: spacing.md },
  modalTitle: { fontSize: fontSize.lg, fontFamily: 'Inter_700Bold' },
  modalDesc: { fontSize: fontSize.base, fontFamily: 'Inter_400Regular' },
  option: { padding: spacing.md, borderRadius: radius.sm, borderWidth: 1.5 },
